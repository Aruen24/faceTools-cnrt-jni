...
////    }
//
//    public Test_multi_cnrt(FaceTools face_tools, int number, CountDownLatch latch, List<String> fileResult,  int rotation, int picSize, long cnrt_facedetect_sess, int startIndex, int endIndex)
//    {
...
//
//            Thread thread = new Test_multi_cnrt(face_tools, i, latch, fileResult, rotation, picSize, cnrt_facedetect_sess, start, end);
//            thread.start();
//        }
//
