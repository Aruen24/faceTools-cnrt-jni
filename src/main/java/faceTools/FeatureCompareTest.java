...
//
//        //追踪，创建加载模型
//        long cnrt_facedetect_init = face_tools.cnrtNetInit("retinaface_mobile0.25_intx_1_1_int8.cambricon", 0, 0);
...
//        long cnrt_facefeature = face_tools.cnrtNetInit("resnet100_int8_b1_c1_220.cambricon", 0, 0);
//
//
//
...
//
//        //追踪，创建session和初始化
//        long cnrt_facedetect_sess_init = face_tools.forkSession(cnrt_facedetect_init);
//        long cnrt_facetrack_sess = face_tools.forkSession(cnrt_facetrack);
//        face_tools.faceTrackingInit(rgb_init, cnrt_facedetect_sess_init, b1.getWidth(), b1.getHeight(), 350, 2, rotation, picSize);
//
//        //检测，创建session
...
//
//        //检测，推理获得结果
//        Vector<Box> boxes_2 = face_tools.cnrtFaceDetectByRgb(rgb_2, byte_2.getWidth(), byte_2.getHeight(), rotation, picSize, 0, cnrt_facedetect_sess);
//        int[] box_2 = boxes_2.get(0).box;
//        System.out.println("检测出来的人脸框：" + "left:" + box_2[0] + "," + "top:" + box_2[1] + "," + "right:" + box_2[2] + "," + "bottom:" + box_2[3]);
//        feature_2 = face_tools.cnrtForwardByFeature(rgb_2, byte_2.getWidth(), byte_2.getHeight(), box_2[0], box_2[1], box_2[2] - box_2[0], box_2[3] - box_2[1], rotation, 112, 0, cnrt_facefeature_sess);
//
//
//        //追踪，更新和获取人脸
...
//            face_tools.trackingUpdate(rgb_1, cnrt_facetrack_sess, cnrt_facedetect_sess, byte_1.getWidth(), byte_1.getHeight(), rotation, picSize);
...
//                feature_1 = face_tools.cnrtForwardByFeature(rgb_1, byte_1.getWidth(), byte_1.getHeight(), box_1[0], box_1[1], box_1[2] - box_1[0], box_1[3] - box_1[1], rotation, 112, 0, cnrt_facefeature_sess);
//                //特征比对
...
//        face_tools.cnrtSessionRelease(cnrt_facedetect_sess_init);
//        face_tools.cnrtSessionRelease(cnrt_facetrack_sess);
//        face_tools.cnrtSessionRelease(cnrt_facefeature_sess);
//        face_tools.cnrtNetRelease(cnrt_facedetect_init);
